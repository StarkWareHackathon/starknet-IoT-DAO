...
from starkware.cairo.common.uint256 import (
    Uint256, uint256_le, uint256_lt, uint256_add, uint256_eq, uint256_unsigned_div_rem)
...
from openzeppelin.token.erc721.tokenURI_library import (
    ERC721_tokenURI, ERC721_setBaseTokenURI, ERC721_tokenURI_test)
...
namespace IVerify:
    func meta_data_verify(
            address : felt, level : felt, ipfs_uri : Uint256, timestamp : Uint256, sig_r : felt,
            sig_s : felt) -> (res : felt):
    end
end
...
func constructor{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        name : felt, symbol : felt, tokenURI_len : felt, tokenURI : felt*, verify_address : felt,
        dao_address : felt):
...
@view
func currentId{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}() -> (
        last_id : Uint256):
...
@view
func getLastTimestamp{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
...
@view
func getLastTokenId{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
...
@view
func getNumberOfTokensByAddress{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
...
@view
func getTokenFromAddressArray{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        address : felt, index : felt) -> (token : Uint256):
    let (token : Uint256) = tokens_by_address.read(address, index)
    return (token)
end
